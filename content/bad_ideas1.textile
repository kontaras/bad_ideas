###. bi.title Bad Ideas, Part 1: Getting Started
###. bi.tag bad_ideas
###. bi.tag dev_log
###. bi.date 2022-10-15
...
For now, the renderer is just running the files through a textile. In the future, it can be expanded to inject more content into pages:
...
!{width: 100%}../media/bad_ideas1/github_pages.png(GitHub Pages configuration)!:../media/bad_ideas1/github_pages.png
